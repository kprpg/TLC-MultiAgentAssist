import type { McemGuidanceConnector, StageGuidance } from '../../../packages/connectors/common/index.js'

// Canned MCEM stage-exit criteria (mirrors the shared fixture) so the extension host never
// pulls the sharepoint/pdfjs chain, which references the browser-only DOMMatrix global.
const stageThreeGuidance: StageGuidance = {
    ...
    sourceHealth: {
        source: 'mcem',
        state: 'sample',
        detail: 'Versioned fixture criteria bundled with the extension; canonical SharePoint path remains unverified.',
        checkedAt: '2026-08-24T00:00:00.000Z'
    }
}

/** No-PDF MCEM guidance for the extension host; evaluates live opportunity context against canned criteria. */
export class ExtensionMcemGuidanceConnector implements McemGuidanceConnector {
