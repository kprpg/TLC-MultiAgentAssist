...
const lifecycleCriteria: StageCriterion[] = [
  { id: 'customer-outcome', label: 'Measurable customer outcome', ownerRole: 'ATS', actionWhenMissing: 'Agree the planned outcome, milestone, measurement, and customer review rhythm.', rationale: 'The MCEM Overview says teams should measure progress against planned outcomes and milestones.' },
  ...
  { id: 'technical-validation', label: 'Outcome and exit-criteria evidence', ownerRole: 'Solution Engineer (SE)', actionWhenMissing: 'Define the evidence needed to demonstrate the current stage outcomes and exit criteria.', rationale: 'MCEM stage progression is driven by achieved outcomes and exit criteria, not completed activities.' },
  { id: 'business-case', label: 'Business-priority alignment', ownerRole: 'Specialist / SSP', actionWhenMissing: 'Connect the opportunity to the customer priority, expected return, and available budget.', rationale: 'MCEM aligns customer needs, business outcomes, and solutions throughout the lifecycle.' },
  { id: 'next-step', label: 'Governed next step', ownerRole: 'CSA / CSAM', actionWhenMissing: 'Agree a dated next step that advances an outcome or exit criterion with named owners.', rationale: 'Customer planning requires coordinated execution and adjustment as needs and priorities evolve.' }
]
