...
const sampleRows: Record<InitialWorkflowId, Array<Record<string, unknown>>> = {
    ...
    'WF-002': [{ id: 'milestone-grid', opportunityId: 'opp-grid-modernization', name: 'Architecture sign-off', status: 'At Risk', targetDate: '2026-09-01' }],
    'WF-003': [{ id: 'milestone-stage-gap', opportunityId: 'opp-grid-modernization', name: 'Customer outcome evidence', status: 'At Risk', targetDate: '2026-09-05' }],
    'WF-005': [{ id: 'milestone-governance', opportunityId: 'opp-ai-service', name: 'Proof review', status: 'Blocked', targetDate: '2026-09-10' }],
    'WF-006': [{ id: 'opp-grid-modernization', accountId: 'account-contoso', name: 'Grid operations modernization', closeDate: '2026-10-30' }],
    'WF-007': [{ id: 'meeting-grid', opportunityId: 'opp-grid-modernization', subject: 'Executive architecture review', ownerId: 'owner-1', dueDate: '2026-09-18', status: 'Open' }],
    'WF-009': [
        { id: 'opp-grid-modernization', accountId: 'account-contoso', name: 'Grid operations modernization', ownerId: 'owner-1', closeDate: '2026-10-30' },
        { id: 'opp-cloud-security-readiness', accountId: 'account-contoso', name: 'Cloud security readiness', ownerId: 'owner-1', closeDate: '2027-02-26' }
    ],
    'WF-010': [{ id: 'activity-grid', opportunityId: 'opp-grid-modernization', subject: 'Customer follow-up', ownerId: 'owner-1', dueDate: '2026-08-01', status: 'Open' }],
    'WF-012': [
        { id: 'milestone-exit-1', opportunityId: 'opp-grid-modernization', name: 'Decision criteria confirmed', status: 'Completed', targetDate: '2026-09-08' },
        { id: 'milestone-exit-2', opportunityId: 'opp-grid-modernization', name: 'Execution owner assigned', status: 'At Risk', targetDate: '2026-09-12' }
    ]
}
